...
is( ld('four','for'),               1,  'ld insertion');
is( ld('four','four'),              0,  'ld matching');
is( ld('four','fourth'),            2,  'ld deletion');
is( ld('four','fuor'),              2,  'ld (no) transposition');
is( ld('four','fxxr'),              2,  'ld substitution');
is( ld('four','FOuR'),              3,  'ld case');
is( ld('four',''),                  4,  'ld target empty');
is( ld('','four'),                  4,  'ld source empty');
is( ld('',''),                      0,  'ld source and target empty');
is( ld('111','11'),                 1,  'ld numbers');
...
# test max distance
is( ld("foo","four",1),           Nil,  "(max distance) Correct ld foo four");
